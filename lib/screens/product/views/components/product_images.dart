          ...
          children: [
            PageView.builder(
              ...
              itemBuilder: (context, index) {
                final isVideo = widget.isVideoList?[index] ?? false;
                final isFilePath = widget.isFilePathList?[index] ?? false;
                final media = widget.images[index];

                Widget mediaWidget;

                if (isFilePath) {
                  mediaWidget = Image.file(File(media), fit: BoxFit.cover);
                } else {
                  mediaWidget = NetworkImageWithLoader(media);
                }
