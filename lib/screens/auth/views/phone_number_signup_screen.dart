...
class PhoneNumberSignupScreen extends StatefulWidget {
  ...
  @override
  State<PhoneNumberSignupScreen> createState() => PhoneNumberSignupState();
}

class PhoneNumberSignupState extends State<PhoneNumberSignupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset("assets/images/primary/farmer2.jpg", fit: BoxFit.cover, height: 350, width: double.infinity,),
            // SizedBox(height: 50,),
            Padding(
                      ...
                      if (_formKey.currentState?.validate() ?? false) {
                        ...
                        try {
                          final response = await AuthService()
                              .validateSignUpPhoneNumberAndSentOtp(
