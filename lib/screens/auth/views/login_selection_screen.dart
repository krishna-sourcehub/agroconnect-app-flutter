        ...
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              ...
              fit: BoxFit.cover,
              // color: Colors.black.withOpacity(0.4), // ← This makes it look dull
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  stops: [0.2, 0.4, 0.5, 1.0], // Controls spread of each color
                ),
              ),
            ),
          ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.pushNamed(context, phoneNumberLoginScreenRoute);
                      },
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.white,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.pushNamed(context, signUpSelectionScreenRoute);
                          },
                          child: const Text("Sign up", style: TextStyle(color: Colors.deepOrange, fontWeight: FontWeight.w700),),
                        ),
