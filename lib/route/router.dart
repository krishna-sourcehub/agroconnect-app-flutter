import 'package:agroconnect/AppStart.dart';
import 'package:agroconnect/screens/auth/views/login_selection_screen.dart';
import 'package:agroconnect/screens/auth/views/password_recovery.dart';
import 'package:agroconnect/screens/auth/views/signup_selection_screen.dart';
import 'package:agroconnect/screens/profile/views/user_profile_screen.dart';
import 'package:flutter/material.dart';
import 'package:agroconnect/entry_point.dart';

import '../models/regular_product_model.dart';
import '../screens/auth/views/terms_and_service_screen.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  ...
  //   );
    ...
    case logInSelectionScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const LoginSelectionScreen(),
      );
    case signUpSelectionScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const SignupSelectionScreen(),
      );
    case phoneNumberLoginScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const PhoneNumberLoginScreen(),
      );
    case phoneNumberOtpVerifyScreenRoute:
      final args = settings.arguments as Map<String, dynamic>;

      return MaterialPageRoute(
        builder: (context) => PhoneNumberOtpVerifyScreen(phoneNumber: args['phoneNumber'],),
      );
    case phoneNumberSignupScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const PhoneNumberSignupScreen(),
      );

    case getupiIdScreenRoute:
      return MaterialPageRoute(
        builder: (context) => GetupiidScreen(),
      );
    ...
    case passwordRecoveryScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const CustomPasswordRecoveryScreen(),
      );
    ...
    case userDataInfoScreenRoute:
      final args = settings.arguments as Map<String, dynamic>;
      return MaterialPageRoute(
        builder: (context) => UserDataInfoScreen(
          email: args['email'],
          phoneNumber: args['phoneNumber'],
        ),
      );
  // case verificationMethodScreenRoute:
    ...
    case productDetailsScreenRoute:
      return MaterialPageRoute(
        builder: (context) {
          final BackendProduct product = settings.arguments as BackendProduct; // Retrieve the product object
          // bool isProductAvailable = settings.arguments as bool? ?? true;
          return ProductDetailsScreen(
            // isProductAvailable: isProductAvailable,
            product: product,  // Pass the product to the ProductDetailsScreen
          );
        },
      );
